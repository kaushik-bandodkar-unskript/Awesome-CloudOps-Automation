...
class InputSchema(BaseModel):
    ...
    privacy: Optional[GithubTeamPrivacy] = Field(
        description=('Privacy type to be given to the team. "secret" - only visible '
                     'to organization owners and members of this team, "closed"- visible '
                     'to all members of this organization. By default type "secret" will be considered. '), 
        title='Privacy'
    )
...
def github_create_team(
    ...
    """github_create_team returns details of newly created team.
        ...
        :type privacy: Enum
        :param privacy: Privacy type to be given to the team. "secret" - only visible to 
        organization owners and members of this team, "closed"- visible to all members of this 
        organization. By default type "secret" will be considered. 
